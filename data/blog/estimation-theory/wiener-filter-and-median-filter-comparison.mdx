...
Figure 1. Noisy Image generation σ=10, 20, 30.
Confirm σ1, σ2, σ3

Figure 2. Confirm 𝜎1, 𝜎2, 𝜎3 by calculating rms values.
...
Figure 6. Results of applying Wiener Filter to restore noisy images, σ=10,20,30
Calculate rms error
...
<div className="text-center">_Figure 9. Results of denoising using Median Filter, σ=30_</div>
