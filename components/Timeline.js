...
const Timeline = () => {
  return (
    <div className="border-2 rounded-lg dark:border-gray-100">
      <CustomHeading customClasses="px-3" heading="h2">
        Timeline
      </CustomHeading>
      <ol className="border-l-2 border-teal-600 dark:text-gray-50 pt-8 ">
        {timelineData.map(({ tid, title, date, image_source, description, href }, index) => (
          <li key={index}>
            <div className="flex flex-start items-center">
              ...
              <h4 className="text-gray-800 font-semibold mt-2 dark:text-gray-50">{title}</h4>
            </div>
