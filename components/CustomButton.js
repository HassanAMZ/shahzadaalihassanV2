...
const CustomButton = ({ scheme, customClasses, ...rest }) => {
  ...
  if (scheme === 'solid') {
    ...
    ButtonScheme =
      'inline-flex w-full justify-center  items-center p-2 text-sm font-medium text-center  dark:text-gray-900 rounded-lg border dark:border-gray-300 dark:hover:bg-gray-100 focus:ring-4 dark:focus:ring-gray-100 text-white border-gray-600 hover:bg-gray-600 focus:ring-gray-800'
