...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white rounded-sm border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        ...
        <CustomLink
          href={`/blog/${slug}`}
          className="inline-flex gap-2 items-center underline text-sm font-medium text-center text-teal-700 dark:text-teal-400 rounded-sm "
        >
          Read more
          <FaArrowRight />
        </CustomLink>
